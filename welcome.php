...
<head>
    ...
    <title>Welcome | Online Tests</title>
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Online Tests </b></a>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if(@$_GET['q']==1) 
                {   
                    echo '<marquee  height="100px" scrollamount="10" style="color:white"><h2>Welcome To Hack4Hire</h2></marquee>
                    <h2 style="text-align:center; color:White">Exams Available</h2>';
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {   
                        echo '<h2 style="text-align:center; color:White">Exams History</h2>';
                    ...
                    if(@$_GET['q']== 3) 
                    {
                        echo '<h2 style="text-align:center; color:White">Exams Ranking</h2>';
